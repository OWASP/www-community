...
- [OWASP Cheat Sheet Series: HTTP Headers Cross-Origin Resource Sharing](https://cheatsheetseries.owasp.org/cheatsheets/HTTP_Headers_Cheat_Sheet.html#cross-origin-resource-policy-corp)
