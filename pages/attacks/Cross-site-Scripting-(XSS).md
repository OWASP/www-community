...
test for the various kinds of XSS vulnerabilities.
  ...
  - [Testing_for_Reflected_Cross_site_scripting_(OWASP-DV-001)](https://github.com/OWASP/wstg/blob/master/document/4-Web_Application_Security_Testing/07-Input_Validation_Testing/01-Testing_for_Reflected_Cross_Site_Scripting.md "wikilink")
  - [Testing_for_Stored_Cross_site_scripting_(OWASP-DV-002)](https://github.com/OWASP/wstg/blob/master/document/4-Web_Application_Security_Testing/07-Input_Validation_Testing/02-Testing_for_Stored_Cross_Site_Scripting.md "wikilink")
  - [Testing_for_DOM-based_Cross_site_scripting_(OWASP-DV-003)](https://github.com/OWASP/wstg/blob/master/document/4-Web_Application_Security_Testing/11-Client_Side_Testing/01-Testing_for_DOM-based_Cross_Site_Scripting.md "wikilink")
...
Cheat Sheet](../../xss-filter-evasion-cheatsheet "wikilink") which is a true
