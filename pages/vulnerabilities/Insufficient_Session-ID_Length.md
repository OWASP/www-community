...
Hexadecimal encoding is commonly used in session identifiers. Each hexadecimal character (0-9, A-F) can represent 4 bits of entropy, so to achieve 64 bits of entropy, you need at least 16 hexadecimal characters. Let’s explore good and bad examples of hexadecimal session IDs to better understand this:
