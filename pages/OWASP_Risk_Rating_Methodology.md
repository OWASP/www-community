...
the likelihood of a successful attack by this group of threat agents. Use the worst-case threat agent.
  ...
  - **Skill Level** - How technically skilled is this group of threat agents? No technical skills (9), some technical skills (7), advanced computer user (6), network and programming skills (5), security penetration skills (3) 
