...
* Mailing list: Each project has its own development mailing list (eg. ESAPI: https://lists.owasp.org/pipermail/esapi-dev/). Feel free to subscribe in order to discuss your ideas directly with the project's contributors.
